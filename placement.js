...
var mathQuestions = [
    ...
    [
        ...
        ['Dave and Ryan jumped on the couch a combined total of 74 times. Then the couch broke, and they both got in big trouble. If Dave jumped on the couch 28 times, how many times did Ryan jump on it?',[['46', 't'], ['102', 'f'], ['37', 'f'], ['56', 'f']], 60],
        ['There are 117 frogs in a bog. To the nearest ten, how many frogs are in the bog?',[['120', 't'], ['115', 'f'],['110', 'f'],['100', 'f']], 60],
